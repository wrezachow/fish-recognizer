...
<img srec = "deployment/thumbnail.png">
<br/>

# API integration wit GitHub pages
deployed the model [here](https://wrezachow.github.io/fish-recognizer) in GitHub Pages Website. more info in 'docs' regarding implementation.
